...
import { collection, doc, deleteDoc, getDocs, updateDoc, addDoc, getDoc, query, orderBy, setDoc, getFirestore, collectionGroup, where } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/firebase@10.14.0/node_modules/firebase/firestore/dist/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/ufo@1.5.4/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/vue@3.5.11_typescript@5.6.2/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/@unhead+ssr@1.11.7/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/ofetch@1.4.0/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/unenv@1.10.0/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/ohash@1.1.4/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/unstorage@1.12.0_ioredis@5.4.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/unstorage@1.12.0_ioredis@5.4.1/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/consola@3.2.3/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/unctx@2.3.1/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/vue@3.5.11_typescript@5.6.2/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/unhead@1.11.7/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/cody/git/veloris-dashboard/node_modules/.pnpm/@unhead+shared@1.11.7/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/cody/git/veloris-dashboard/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/cody/git/veloris-dashboard","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/cody/git/veloris-dashboard/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/cody/git/veloris-dashboard/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/cody/git/veloris-dashboard/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/cody/git/veloris-dashboard/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _YmSTe9tZXV = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/cody/git/veloris-dashboard";
...
const _lazy_RkCZBm = () => Promise.resolve().then(function () { return _id__get$2; });
...
const _lazy_OC43hT = () => Promise.resolve().then(function () { return index_get$7; });
const _lazy_Z33rJ4 = () => Promise.resolve().then(function () { return index_post$9; });
const _lazy_RHhGz7 = () => Promise.resolve().then(function () { return index_put$7; });
...
const _lazy_ETZE5H = () => Promise.resolve().then(function () { return index_put$5; });
...
const _lazy_WbsKRy = () => Promise.resolve().then(function () { return _category__post$1; });
const _lazy_pLJQs2 = () => Promise.resolve().then(function () { return _id__get; });
const _lazy_RnAa7g = () => Promise.resolve().then(function () { return index_post$5; });
const _lazy_JBpQ1N = () => Promise.resolve().then(function () { return index_put$3; });
const _lazy_4C1VL9 = () => Promise.resolve().then(function () { return _id__put$1; });
const _lazy_yhw6HX = () => Promise.resolve().then(function () { return index_get$3; });
...
const getClientManifest = () => import('file:///home/cody/git/veloris-dashboard/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/cody/git/veloris-dashboard/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
