...
export const stripeCheckout = async (total: number, itemName: string, order: OrderObj) => {
    try {
...
async function createPaymentIntent(total: Number, itemName: String, order: OrderObj) {
