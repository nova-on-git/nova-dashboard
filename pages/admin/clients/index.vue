    ...
    <main class="projects-container">
                ...
                <div class="project-info">
                    ...
                    <p v-if="project.quote">
                        <strong>Total Amount:</strong> ${{
                            (project.quote.totalAmount / 100).toFixed(2)
                        }}
                    </p>
                </div>
                <btn class="view-details-btn" :to="`/admin/clients/${project.id}`"
                    >View Details</btn
                >
            </div>
        </div>
        ...
        <div class="actions">
            <modal id="createProject">
                <form
                    @submit.prevent="$Projects.create(projectDetails)"
